...
<div class="jumbotron">
    <div class="row">
        {!! Form::open(['action'=>['housesController@update','method'=>'POST',$houses->id],'enctype'=> 'multipart/form-data']) !!}
            <div class="form-group">
                {{Form::label('title','House Title')}}
                {{Form::Text('title' ,$houses->name,['class'=>'form-control','placeholder'=>'House Title'])}}
            </div>
            
            <div class="form-group">
                {{Form::label('description', 'Description')}}
                {{Form::textArea('description',$house->description, ['class'=>'form-control', 'placeholder'=>'Description'])}}
            </div>
            ...
            <div class="form-group">
                ...
                {{Form::number('price', $houses->price, ['class'=>'form-control', 'placeholder'=>'Price in kshs'])}}
            </div>
